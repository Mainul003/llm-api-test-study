...
\usepackage{balance}
\usepackage[final,stretch=10,shrink=10]{microtype}
\usepackage{url}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth]{fig1_endpoint_coverage.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth]{fig2_ddr.png}
